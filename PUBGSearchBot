        ...
        try:
            ...
            if len(message.content.split(" ")) == 1:
                ...
                if soloQueInfo == None:
                    ...
                    await message.channel.send("PUBG player " + playerNickname + "'s solo que information", embed=embed)
                else:
                    # print(soloQueInfo)
                    # Get total playtime
            ...
            if len(message.content.split(" ")) == 1:
                ...
                if duoQueInfo == None:
                    embed = discord.Embed(title="Record not found", description="Duo que record not found.",
                                          color=0x5CD1E5)
                    embed.add_field(name="Player search from dak.gg", value=URL, inline=False)
                    await message.channel.send("PUBG player " + playerNickname + "'s duo que information", embed=embed)
                else:
                    # print(duoQueInfo)
                    # Get total playtime
            ...
            if len(message.content.split(" ")) == 1:
                ...
                if duoQueInfo == None:
                    embed = discord.Embed(title="Record not found", description="Squad que record not found.",
                                          color=0x5CD1E5)
                    embed.add_field(name="Player search from dak.gg", value=URL, inline=False)
                    await message.channel.send("PUBG player " + playerNickname + "'s squad que information", embed=embed)
                else:
                    # print(duoQueInfo)
                    # Get total playtime
